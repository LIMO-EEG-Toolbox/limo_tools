function [b,W] = limo_WLS(X,Y,flag)
...
if flag == 1 % get the weights from PC on adjusted residuals
...
else % find b such as  V = I i.e. minimize the restricted maximum likelihood objective function:
    for f=1:size(Y,2)
