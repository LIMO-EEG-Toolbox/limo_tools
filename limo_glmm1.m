...
% General Linear multivariate model for 1st level analysis of EEG data
...
% trials and considering the pattern of effect acroos all electrodes .
%
% FORMAT:
% model = limo_glm(Y,LIMO)
% model = limo_glm(Y,X,nb_conditions,nb_interactions,nb_continuous,method,W)
%
% INPUTS:
%   Y             = 2D matrix of EEG data with format trials x electrodes
