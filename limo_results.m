...
if ispc
    handles.filter = {'R2.mat','Model fit';
        ...
        'semi_partial_coef*.mat','F test for specific contribution to the data'; ...
    ...
    handles.filter = {[ 'R2.mat; Condition_effect*.mat; Covariate_effect*.mat; Interaction_effect*.mat; ' ... 
        'semi_partial_coef*.mat; con_*.mat; ess_*.mat;' ...
        'one_sample*.mat; two_samples*.mat; paired_samples*.mat; Rep_ANOVA*.mat' ] 'LIMO compatible files' };
end
